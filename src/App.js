...
class App extends React.Component{
  ...
  async fetchCoins() {
    try {
      ...
      //function for sort method to sort in decreasing order
      function Comparator(a, b) {
        if (a.price_change > b.price_change) return -1;
        if (a.price_change < b.price_change) return 1;
        return 0;
      }
      //sorting new_list in decreasing order based on price change in 24h
              ...
              <div className="list-items">
                {
                  ...
                  return <li key={index}>
                    <img className="picture" src={c.image}/> 
                    {c.name} 
